...
\begin{proof}
    ...
    \leanok
    Clear because of \ref{MyRat.mul_inv_cancel}.
\end{proof}
...
\begin{proof}
    ...
    \leanok
    We have $i(a+b) = \llbracket (a+b, 1) \rrbracket$, $i(a) = \llbracket (a, 1) \rrbracket$ and
    $i(b) = \llbracket (b, 1) \rrbracket$, so we need to prove that
\[
\llbracket (a+b, 1) \rrbracket = \llbracket (a, 1) \rrbracket + \llbracket (b, 1) \rrbracket
\]
that is obvious from the definition.
\end{proof}
...
\begin{proof}
    ...
    \leanok
    We have $i(a*b) = \llbracket (a*b, 0) \rrbracket$, $i(a) = \llbracket (a, 1) \rrbracket$ and
    $i(b) = \llbracket (b, 1) \rrbracket$, so we need to prove that
\[
\llbracket (a*b, 1) \rrbracket = \llbracket (a, 1) \rrbracket * \llbracket (b, 1) \rrbracket
\]
...
\begin{proof}
    \uses{MyRat.i}
    \leanok
    Let $a$ be such that $i(a)=0$. This means $\llbracket (a,1) \rrbracket = \llbracket (0,1) \rrbracket$ so $a * 1 = 1 * 0$ and hence $a = 0$.
\end{proof}