...
\begin{definition}
    ...
    \lean{MyPrereal.sub}
    \leanok
    \uses{MyPrereal.add, MyPrereal.neg}
...
\begin{definition}
    \label{MyReal.neg}
    \lean{MyReal.neg}
    \uses{MyReal, MyPrereal.neg, MyPrereal.neg_quotient}
    \leanok
...
\begin{definition}
    \label{MyReal.add}
    \lean{MyReal.add}
    \uses{MyReal, MyPrereal.add, MyPrereal.add_quotient}
    \leanok
...
\begin{definition}
    \label{MyReal.mul}
    \lean{MyReal.mul}
    \uses{MyReal, MyPrereal.mul, MyPrereal.mul_quotient}
    \leanok
...
\begin{definition}
    \label{MyReal.inv}
    \lean{MyReal.inv}
    \uses{MyReal, MyPrereal.inv, MyPrereal.inv_quotient}
    \leanok
...
\begin{definition}
    ...
    \uses{MyReal, MyPrereal.isNonneg_quotient, MyPrereal.IsNonneg}
    \leanok
